...
class CLI(private val _asJava: Object) {
   ...
   * displaying usages / help messages. In other words, hidden commands are for power user.   * @param hidden enables or disables the hidden aspect of the CI
   * @return the current CLI instance
   */
  ...
  /**
   * Adds an option.   * @param option the option, must not be `null`. see <a href="../../../../../../../cheatsheet/Option.html">Option</a>
   * @return the current CLI instance
   */
   ...
   * The given list is appended to the existing list.   * @param options the options, must not be `null`
   * @return the current CLI instance
   */
  ...
  /**
   * Sets the list of arguments.   * @param options the list of options, must not be `null`
   * @return the current CLI instance
   */
  ...
  /**
   * Adds an argument.   * @param arg the argument, must not be `null` see <a href="../../../../../../../cheatsheet/Argument.html">Argument</a>
   * @return the current CLI instance
   */
   ...
   * The given list is appended to the existing list.   * @param args the arguments, must not be `null`
   * @return the current CLI instance
   */
  ...
  /**
   * Sets the list of arguments.   * @param args the list of arguments, must not be `null`
   * @return the current CLI instance
   */
  ...
  /**
   * Checks whether or not the current [[io.vertx.scala.core.cli.CLI]] instance is hidden.   * @return `true` if the current CLI is hidden, false otherwise
   */
  ...
  /**
   * Gets an <a href="../../../../../../../cheatsheet/Option.html">Option</a> based on its name (short name, long name or argument name).   * @param name the name, must not be `null`
  ...
  /**
   * Gets an <a href="../../../../../../../cheatsheet/Argument.html">Argument</a> based on its name (argument name).   * @param name the name of the argument, must not be `null`
  ...
  /**
   * Gets an <a href="../../../../../../../cheatsheet/Argument.html">Argument</a> based on its index.   * @param index the index, must be positive or zero.
   * @return the Argument, `null` if not found.see <a href="../../../../../../../cheatsheet/Argument.html">Argument</a>
   */
